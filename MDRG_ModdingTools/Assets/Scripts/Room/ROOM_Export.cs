...
public class ROOM_Export : MonoBehaviour
{
    ...
    public void ExportMod()
    {
        ...
        filePaths = new string[content.transform.childCount];
        relativePaths = new string[content.transform.childCount];
        createJSON();
        createLUA();
    ...
    private void createLUA()
    {
        ...
        for (int i = 2; i < content.transform.childCount; i++)
        {
            ...
            filePaths[i] = savePath + "/" + CleanName(content.transform.GetChild(0).GetComponentInChildren<TMP_InputField>().text) + "/" + auxPath1[auxPath1.Length - 1] + "/" + auxPath2[auxPath2.Length - 1];
            relativePaths[i] = auxPath1[auxPath1.Length - 1] + "/";
            ...
            LUA += "-- Item ID" + count.ToString() + ":\n" +
                ...
                "itemprefab" + count.ToString() + ".PossibleEquipmentSlots = {'Room_Item_" + count.ToString() + "'}\n" +
